...
const SHELL_CACHE = 'templum-shell-v27';   // v26 복습 · v27 객관식(6단계)
...
const SHELL_FILES = [
  ...
  './js/data/drive-files.js', './js/data/uplink.js', './js/data/review.js', './js/data/mcq.js',
  ...
  './js/features/review/review.js', './js/features/mcq/mcq.js',
