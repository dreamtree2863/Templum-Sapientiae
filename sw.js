...
const SHELL_CACHE = 'templum-shell-v31';   // v30 _state · v31 경로 정규화 + 빈 화면 진단
...
const SHELL_FILES = [
  ...
  './js/data/drive-files.js', './js/data/uplink.js', './js/data/review.js', './js/data/mcq.js', './js/data/search.js',
